...
def generate_launch_description():
    ...
    capture_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            'rviz': 'false',
            'auto_start': 'true',
            'world': '/ws/.external_worlds/aws-robomaker-small-house-world/worlds/small_house.world',
            'map': '/ws/.external_worlds/aws-robomaker-small-house-world/maps/turtlebot3_waffle_pi/map.yaml',
            'params_file': PathJoinSubstitution([
                FindPackageShare('my_robot_navigation'),
                'config',
                'nav2_params_small_house.yaml',
            ]),
            'waypoints_file': PathJoinSubstitution([
                FindPackageShare('my_robot_navigation'),
                'config',
                'waypoints_small_house.yaml',
            ]),
            'spawn_x': '-8.425',
            'spawn_y': '0.025',
            'spawn_yaw': '-0.081',
            'extra_gazebo_model_path': '/ws/.external_worlds/aws-robomaker-small-house-world/models',
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('run_name', default_value='small_house_capture'),
