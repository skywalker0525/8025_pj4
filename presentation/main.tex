...
\begin{frame}{Project Goal}
  \begin{block}{Background}
    Construction sites are dynamic, cluttered, and safety-critical. Autonomous mobile robots can support inspection work by navigating through site-like areas, checking target locations, and giving operators live feedback without sending people into every space manually.
  \end{block}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.42\textwidth}
      \begin{block}{Task pipeline}
        \begin{enumerate}
          \item Start from A.
          \item Plan around obstacles with Nav2.
          \item Approach the wall AprilTag.
          \item Report mission state as \texttt{DONE}.
        \end{enumerate}
      \end{block}
    \end{column}
  \end{columns}
    ...
    \begin{column}{0.45\textwidth}
      \begin{block}{Mapping mode}
        \begin{itemize}
          ...
          \item Save the map for later Nav2 runs
        \end{itemize}
      \end{block}
      \begin{block}{Navigation mode}
        \begin{itemize}
          ...
          \item Diff-drive plugin publishes \texttt{odom -> base\_link}
          \item Nav2 plans through global/local costmaps
        \end{itemize}
      \end{block}
    \end{column}
  \end{columns}
...
\begin{frame}{Conclusion}
  ...
  \vspace{0.8em}
  \begin{center}
    \Large Next: recorded mission video.
  \end{center}
\end{frame}
